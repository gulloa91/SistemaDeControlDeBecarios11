...
public class EmailServices
{
    ...
    public bool enviarCorreoCuentaCreada(String correo_destino, String nombre_completo, String contrasena, String usuario)
    {
        try
        {
            ...
            mail.Body = "<html><body><div style='width: 80%; margin:0 10%; border-radius: 5px; border: 2px solid #414141; font-size: 16px; background: #2F4F2F;'> <div style='margin: 5%; width: 90%;background: #FFF; border-radius: 5px;'> <div style='padding: 5px 5%; width: 90%; text-align: center;'> <img src='http://www.ecci.ucr.ac.cr/files/bluebreeze_logo.png' /> <p style='font-size: 18px; font-weight: bold;'>¡Bienvenido al Sistema de Control de Becarios 11!</p> <p style='font-size: 16px; font-style: italic;'>Un proyecto de estudiantes para estudiantes de la Escuela de Ciencias de la Computación e Informática.</p> </div> <div style='padding: 5px 5%; width: 90%;'> <p>Sus credenciales han sido creadas satisfactoriamente. A continuación se le muestra su información para poder ingresar al sistema:</p> <p><b>Nombre:</b>  " + nombre_completo + "</p> <p><b>Usuario:</b>  " + usuario + "</p> <p><b>Contraseña:</b>   " + contrasena + "</p> <p>Para empezara a utilizar el sistema por favor rediríjase a la siguiente página y revisa sus datos personales:</p> <p style='text-align: center;'><a href='#'>www.pruebadeservidor.ecci.ucr.ac.cr</a></p> </div> <div style='padding: 5px 5%; width: 90%; text-align: center;'> <p style='font-size: 16px; font-style: italic;'>Proyecto de Ingeniería de Software II | Grupo 2 | 2013</p> </div> </div> </div></body></html>";
